...
#    Date: 12.03.2018 
# 
# Summary: Modelling the RevPAR prediction for Support Vector Machine
#
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="RMSE/RevPAR" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,500), main ="RMSE for RevPAR Estimation by SVM")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )

# Add a legend
legend("bottomleft", 
       legend = c("RMSE SVM", "RMSE Mean Prediction", "Mean RevPAR"), 
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="MAE/RevPAR" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,300), main ="MAE for RevPAR Estimation by SVM")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )

# Add a legend
legend("bottomleft", 
       legend = c("MAE SVM", "MAE Mean Predicition", "Mean RevPAR"), 
       col = c(rgb(0.2,0.4,0.1,0.7), 
               rgb(0.8,0.4,0.1,0.7), rgb(0.2,0.1,0.8,0.7)), 
       pch = c(17,19,15), 
       bty = "n", 
...
plot(gbmImp, top = 20, main="Variable Importance for SVM RevPAR Estimation")
