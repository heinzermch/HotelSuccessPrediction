...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="RMSE/Revenue" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(1,3000000), main ="RMSE for Revenue Estimation by Linear Regression")
...
# Add a legend
legend("bottomleft", 
       legend = c("RMSE Linear Regression", "RMSE Mean Prediction", "Mean Revenue"), 
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="MAE/Revenue" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,2000000), main ="MAE for Revenue estimation by Linear Regression")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )

# Add a legend
legend("bottomleft", 
       legend = c("MAE Linear Regression", "MAE Mean Prediction", "Mean Revenue"), 
       col = c(rgb(0.2,0.4,0.1,0.7), 
               rgb(0.8,0.4,0.1,0.7), rgb(0.2,0.1,0.8,0.7)), 
       pch = c(17,19,15), 
       bty = "n", 
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="RMSE" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,3000000), main ="RMSE for Training and Test Set Linear Regression")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )
...
plot(gbmImp, top = 20, main="Variable Importance for Linear Regression Revenue Estimation")
