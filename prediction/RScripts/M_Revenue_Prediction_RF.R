...
# xx <- x.side[[1,2,3,4,6,7],]
xx <- x.side[c("V1", "V3", "V4", "V6", "V7")]
print(xx)
...
for(j in 1:nb_cross_validation){
  ...
  if (show_plots){
    ...
    densityplot(imputed_train_hotels, main = "Density Plot for Imputed Attributes")
  }
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="RMSE/Revenue" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(1,2000000), main ="RMSE for Revenue Estimation by Boosted Trees")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )

# Add a legend
legend("bottomleft", 
       legend = c("RMSE Boosted Trees", "RMSE Mean Prediction", "Mean Revenue"), 
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="MAE/Revenue" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,2000000), main ="MAE for Revenue Estimation by Boosted Trees")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )

# Add a legend
legend("bottomleft",
       legend = c("MAE Boosted Trees", "MAE Mean Prediction", "Mean Revenue"), 
       col = c(rgb(0.2,0.4,0.1,0.7), 
               rgb(0.8,0.4,0.1,0.7), rgb(0.2,0.1,0.8,0.7)), 
       pch = c(17,19,15), 
       bty = "n", 
...
# Make a basic graph
plot( b~x , type="b" , bty="l" , xlab="Dataset" , ylab="RMSE" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(0,1500000), main ="RMSE for Training and Test Set")
lines(c ~x , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
lines(d ~x , col=rgb(0.2,0.1,0.8,0.7) , lwd=3 , pch=15 , type="b" )
...
importance[1:10]
head(importance)
xgb.plot.importance(importance_matrix = importance[1:10], main = "Variable Importance for Boosted Trees Revenue Estimation")

#round(error_test,0)
#plot(round(error_test, 0), main = "Estimation errors test set")
